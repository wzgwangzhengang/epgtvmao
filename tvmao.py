...
tvmao_ws_dict = {
    ...
    '厦门电视台厦门卫视': ['/program_satellite/XMTV5-w', 'XMTV5'],
    ...
    '湖南电视台金鹰卡通频道': ['/program_satellite/HUNANTV2-w', 'HUNANTV2'],
    '江苏卫视': ['/program_satellite/STV1-w', 'JSTV1'],
    ...
    '哈哈炫动卫视': ['/program_satelliteTOONMAX1-w', 'TOONMAX1'],
    '陕西卫视': ['/program_satelliteSHXITV1-w', 'SHXITV1'],
    '四川卫视': ['/program_satelliteSCTV1-w', 'SCTV1'],
    '康巴藏语卫视': ['/program_satelliteKAMBA-w', 'KAMBA'],
    '天津卫视': ['/program_satelliteTJTV1-w', 'TJTV1'],
    '新疆卫视': ['/program_satelliteXJTV1-w', 'XJTV1'],
    '云南卫视': ['/program_satelliteYNTV1-w', 'YNTV1'],
    '浙江卫视': ['/program_satelliteZJTV1-w', 'ZJTV1'],
    '青海卫视': ['/program_satelliteQHTV1-w', 'QHTV1'],
    '西藏电视台藏语卫视': ['/program_satelliteXIZANGTV1-w', 'XIZANGTV1'],
    '西藏电视台汉语卫视': ['/program_satelliteXIZANGTV2-w', 'XIZANGTV2'],
